...
module Data.Location.ModelSpec (spec) where
...
spec :: Spec
spec = do
    describe "Data.Location.KML.locationRecordParser" $ do
        it "Converts a JSON snippet to a LocationRecord" $ do
            (J.parseByteString M.LocationRecordsParser (cs googleLocationJSON)) `shouldBe` locationList
...
locationList = [typicalLocationAllFields]
...
typicalLocationAllFields = LocationRecord typicalDate typicalPositiveLongitudeNumber typicalNegativeLatitudeNumber (Just 183) (Just 13)

typicalLocationNoAltitude :: LocationRecord
typicalLocationNoAltitude = LocationRecord typicalDate typicalPositiveLongitudeNumber typicalNegativeLatitudeNumber Nothing (Just 13)

typicalLocationNoAccuracy :: LocationRecord
typicalLocationNoAccuracy = LocationRecord typicalDate typicalPositiveLongitudeNumber typicalNegativeLatitudeNumber (Just 183) Nothing
